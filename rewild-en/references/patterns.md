# Rewild English Pattern Catalog

Read this after `SKILL.md`. Use it as a diagnostic menu, not a checklist you must exhaust every time.
...
Words to watch: stands/serves as, is a testament/reminder, a vital/significant/crucial/pivotal/key role/moment, underscores/highlights its importance, reflects broader, symbolizing its ongoing/enduring, setting the stage for, marks a shift, evolving landscape, indelible mark
...
Fix: state the concrete fact and drop the self-importance.

2. Promotional adjectives.
Words to watch: boasts a, vibrant, rich (figurative), profound, showcasing, exemplifies, commitment to, groundbreaking, renowned, breathtaking, must-visit, stunning, nestled, in the heart of, seamless, intuitive, powerful
...
Fix: replace with a plain claim or a concrete feature the source actually mentions.
...
Fix: replace stock framing with the actual issue.
...
Fix: pull forward real names already in the source.
...
Fix: use a real concrete detail from the source, not an invented one.
...
Before:
> The new framework provides significant improvements over the previous version. It includes better error handling and more comprehensive documentation. Users will appreciate the streamlined API.
...
- Natural sign-offs beat boilerplate.

Blog / essay:
- Voice matters most here.
- A stronger point of view is often appropriate.
- No invented anecdotes.

Technical docs:
- Precision beats personality.
- Focus on removing nominalizations and adding concrete examples.

Business:
- Specificity beats posture.
- Real numbers, real names.

Academic:
- Citation discipline beats style flourishes.
- Keep formality, vary structure.

## Anti-Hallucination Reminder

Never improve "humanity" by adding:
- fake metrics or statistics
- invented meetings, conversations, or anecdotes
...
Academic:
- Tercon & Dobrovoljc (2025) — 44-study synthesis of AI linguistic characteristics
